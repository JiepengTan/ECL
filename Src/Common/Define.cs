namespace LockstepECL {
    public class Define {
        ...
        public static Token[] keywords = new Token[] {
            ...
            new Token(KW_INT8       ,"sbyte",             null),    
            new Token(KW_INT16      ,"short",            null),          
            new Token(KW_INT32      ,"int",            null),    
            new Token(KW_INT64      ,"long",            null),          
            new Token(KW_UINT8      ,"byte",            null),    
            new Token(KW_UINT16     ,"ushort",           null),     
            new Token(KW_UINT32     ,"uint",           null),     
            new Token(KW_UINT64     ,"ulong",           null),         
